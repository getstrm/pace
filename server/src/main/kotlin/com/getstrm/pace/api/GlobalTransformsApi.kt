...
@GrpcService
class GlobalTransformsApi(private val globalTransformsService: GlobalTransformsService) :
    GlobalTransformsServiceGrpcKt.GlobalTransformsServiceCoroutineImplBase() {

    override suspend fun getGlobalTransform(
        request: GetGlobalTransformRequest
    ...
    override suspend fun listGlobalTransforms(
        request: ListGlobalTransformsRequest
    ...
    override suspend fun upsertGlobalTransform(
        request: UpsertGlobalTransformRequest
    ...
    override suspend fun deleteGlobalTransform(
        request: DeleteGlobalTransformRequest
    ): DeleteGlobalTransformResponse =
        DeleteGlobalTransformResponse.newBuilder()
            .setDeletedCount(
                globalTransformsService.deleteTransform(request.ref, request.type.toTransformCase())
            )
            .build()
}
